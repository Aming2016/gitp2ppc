<template>
  <div class="homeindex">
    <ul id="homeindexleft">
    	...
    	<li class="leftli"><img class="homeimgs" style="top:12px" src="../../imgs/mine/wodezhanghu.png"/><div>我的账户</div><img class="homeimgsone" src="../../imgs/mine/xiajiatou.jpg"/></li>
	    	...
	    	<router-link  tag="li" to="/indexcollocation" class="leftli" :class="{activeli:activelis==5}" style="border-top:1px solid #cacaca">
	    		<img v-show="activelis!==5" class="homeimgs" src="../../imgs/mine/tuoguanxinxi.png"/>
    	...
    	<li class="leftli"><img class="homeimgs" src="../../imgs/mine/wodetouzi.png"/><div>我的投资</div><img class="homeimgsone" src="../../imgs/mine/xiajiatou.jpg"/></li>
    	...
    	<li class="leftli" style="border-top:1px solid #cacaca"><img class="homeimgs" src="../../imgs/mine/zijinguanli.png"/><div>资金管理</div><img class="homeimgsone" src="../../imgs/mine/xiajiatou.jpg"/></li>
    	...
    	<li class="leftli" style="border-top:1px solid #cacaca"><img class="homeimgs" src="../../imgs/mine/wodejiangli.png"/><div>我的奖励</div><img class="homeimgsone" src="../../imgs/mine/xiajiatou.jpg"/></li>
	    	<router-link tag="li" to="/indexaward" :class="{activeli:activelis==14}"><div>邀请记录</div></router-link>
	    	<!-- <router-link tag="li" to="/indexintegral" :class="{activeli:activelis==15}"><div>我的积分</div></router-link> -->
	    	<router-link tag="li" to="/indexdiscounts" :class="{activeli:activelis==16}" v-if="my_data.experience_money"><div>我的体验金</div></router-link>
    </ul>
    <div class="center">
...
export default {
  ...
  data () {
    return {
		...
		my_data:JSON.parse(window.sessionStorage.myindexdata)
    }
  },
  created(){
