...
export default {
  data() {
    return {
      ...
      list: ["可投资产", "全家服1号", "全家服2号", "全家服3号",'体验标'],
      list_code: ["", 3, 1, 2, 4],
      active: 0,
      activeone: 0,
      activetwo: 0,
  ...
  created() {
    if(this.$store.state.investonehomeindex){
      this.active=this.$store.state.investonehomeindex;
    this.actives=this.list_code[this.$store.state.investonehomeindex];
    }
  ...
  beforeDestroy(){
    this.$store.state.investonehomeindex=""
  }
};
</script>
