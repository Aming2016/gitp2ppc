<template>
	<div class="register" @keydown.13="btngoashore">
		...
		<div id="boxregister">
			...
			<button class="btn btngohome"  @click="btngoashore" style="margin-top:60px;" >立即登录</button>
			<div id="boxdivtwo">
          ...
          this.$http
            ...
            .then(response => {
              if (response.status == 200) {
                 window.sessionStorage.token="JWT"+" "+response.data.token
                 console.log(window.sessionStorage.token)
                  ...
                  .then((response) => {
                    ...
                    this.$router.push("/");
                    window.sessionStorage.setItem("myindexdata",JSON.stringify( response.data))
                   });
